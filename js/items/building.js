class Building {
    ...
    draw(ctx, viewPoint) {
        ...
        this.ceiling = new Polygon(topPoints);
        ...
        this.base.draw(ctx, { fill: "white", stroke: "#AAAA" });
        for (const side of sides) {
            side.draw(ctx, { fill: "white", stroke: "#AAAA" });
        }
        this.ceiling.draw(ctx, { fill: "white", stroke: "#AAAA" });
    }
}